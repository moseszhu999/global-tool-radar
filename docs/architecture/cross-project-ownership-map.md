...
Product-neutral Shared Media should expose bounded contracts such as render request/result/evidence and remain reusable by TrainingOS, TradeOS and future Domain Apps.
...
3. preserve one owner for render truth, domain truth, publishing truth and execution truth;
